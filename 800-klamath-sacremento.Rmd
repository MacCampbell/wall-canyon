...
ggsave("outputs/800/sac-33-klams-pcs.jpeg", width=10, height=5)
```
...
bcftools reheader --samples ../../bamlists/sacs47.names -o recode.prune.reheadered.vcf recode.prune.vcf
