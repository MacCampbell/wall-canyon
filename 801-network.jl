...
using RCall      
imagefilename = "outputs/801/snaqplot-net0.pdf"
...
using RCall     
imagefilename = "outputs/801/snaqplot-net1.pdf"
R"pdf"(imagefilename, width=4, height=3) 
R"par"(mar=[0,0,0,0]) 
...
using RCall      
imagefilename = "outputs/801/snaqplot-net2.pdf"
R"pdf"(imagefilename, width=4, height=3) 
...
using RCall      
imagefilename1 = "outputs/801/hscores.pdf"
