...
cat bamlists/highrollers.bamlist | while read line; do echo `basename $line .sort.flt.bam`; samtools view -bs $frac $line > data/reduced/`basename $line .sort.flt.bam`.reduced.bam; done;
```
